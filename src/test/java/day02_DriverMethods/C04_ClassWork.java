...
public class C04_ClassWork {
    public static void main(String[] args) {
        ...
        //aramaSonucYazisini konsola yazdiriniz
        String [] sonusSayisi = aramaSonucYazisi.get(0).getText().split(" ");
        System.out.println("Sonus Sayisi: " + sonusSayisi[2]);

        //aramaSonucYazisini lambda ile yazdiriniz
